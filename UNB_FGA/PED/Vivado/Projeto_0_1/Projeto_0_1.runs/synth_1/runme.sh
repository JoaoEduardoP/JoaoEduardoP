...
HD_PWD='C:/Users/joaoe/Desktop/Faculdade/Materias/PED/Vivado/Projeto_0_1/Projeto_0_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log And2Ent.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source And2Ent.tcl
