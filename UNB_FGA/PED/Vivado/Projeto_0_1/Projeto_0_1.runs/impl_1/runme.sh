...
HD_PWD='C:/Users/joaoe/Desktop/Faculdade/Materias/PED/Vivado/Projeto_0_1/Projeto_0_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log And2Ent.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source And2Ent.tcl -notrace
