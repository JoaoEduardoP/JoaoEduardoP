...
HD_PWD='C:/Users/joaoe/Desktop/Faculdade/Materias/PED/Vivado/exp-VHDL2/exp-VHDL2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Dec_Pri.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Dec_Pri.tcl -notrace
