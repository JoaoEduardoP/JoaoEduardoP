...
HD_PWD='C:/Users/joaoe/Desktop/Faculdade/Materias/PED/Vivado/exp-VHDL-5/exp-VHDL-5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cronom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cronom.tcl -notrace
