...
HD_PWD='C:/Users/joaoe/Desktop/Faculdade/Materias/PED/Vivado/exp-VHDL2/exp-VHDL2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dec_Pri.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dec_Pri.tcl
