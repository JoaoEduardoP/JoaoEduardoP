...
HD_PWD='C:/Users/joaoe/Desktop/Faculdade/Materias/PED/Vivado/exp-VHDL-4/exp-VHDL-4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modulo_superior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modulo_superior.tcl -notrace
