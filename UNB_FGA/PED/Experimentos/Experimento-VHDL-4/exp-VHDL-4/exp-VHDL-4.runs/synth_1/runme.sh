...
HD_PWD='C:/Users/joaoe/Desktop/Faculdade/Materias/PED/Vivado/exp-VHDL-4/exp-VHDL-4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulo_superior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulo_superior.tcl
